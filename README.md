...
| **[`host-setup/`](host-setup/)** | **[`fix_tdr_delay.reg`](host-setup/fix_tdr_delay.reg)** | Modificación opcional del Registro de Windows para aumentar el valor de `TdrDelay`. Se utiliza para reducir cuelgues del entorno gráfico de CARLA/Unreal Engine cuando la GPU tarda más de lo esperado en responder. |
